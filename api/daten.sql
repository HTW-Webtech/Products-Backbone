...
INSERT INTO `products` (`id`, `timestamp`, `name`, `url`, `image`, `price`) VALUES
(NULL, NULL, 'Aquaman', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Aquaman.jpg', '123'),
(NULL, NULL, 'Batman', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Batman.jpg', '123'),
(NULL, NULL, 'Captain_America', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Captain_America.jpg', '123'),
(NULL, NULL, 'Catwoman', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Catwoman.jpg', '123'),
(NULL, NULL, 'Cyclops', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Cyclops.jpg', '123'),
(NULL, NULL, 'Deadpool', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Deadpool.jpg', '123'),
(NULL, NULL, 'Human_Torch', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Human_Torch.jpg', '123'),
(NULL, NULL, 'Iceman', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Iceman.jpg', '123'),
(NULL, NULL, 'Invisible_Woman', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Invisible_Woman.jpg', '123'),
(NULL, NULL, 'Iron_Man', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Iron_Man.jpg', '123'),
(NULL, NULL, 'Mister_Fantastic', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Mister_Fantastic.jpg', '123'),
(NULL, NULL, 'Spider_Man', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Spider_Man.jpg', '123'),
(NULL, NULL, 'Storm', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Storm.jpg', '123'),
(NULL, NULL, 'Superman', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Superman.jpg', '123'),
(NULL, NULL, 'The_Flash', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/The_Flash.jpg', '123'),
(NULL, NULL, 'Thor', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Thor.jpg', '123'),
(NULL, NULL, 'Wolverine', 'http://de.wikipedia.org/wiki/Comic', 'http://localhost/Simple-MVC/static/img/Wolverine.jpg', '123');